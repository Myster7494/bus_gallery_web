...
export default function VehicleDetails({ plate }) {
    ...
    return (
        <div>
            <Link
                href="/"
                className="inline-flex items-center gap-2 mb-8 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors group"
            >
                        ...
                        <div key={image.url} className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden shadow-md flex flex-col">
                            ...
                            <div className="p-4 flex flex-col flex-grow">
                                ...
                                <a
                                    ...
                                    className="mt-4 ml-auto inline-flex items-center justify-center h-10 w-10 rounded-full
                                               bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300
                                               hover:bg-blue-500 dark:hover:bg-blue-500 hover:text-white dark:hover:text-white
