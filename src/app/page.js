...
export default function HomePage() {
    ...
    return (
        <div className="space-y-8">
            {/* --- 核心變更：社群連結按鈕改為 Filled Button --- */}
            <div className="flex flex-wrap justify-center items-center gap-4">
                <a
                    href="https://tybusstation.github.io/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-3 px-5 py-3 bg-blue-500 text-white font-semibold rounded-lg shadow-md transform transition-all duration-300 hover:bg-blue-600 hover:scale-105 hover:shadow-lg"
                >
                    {/* 圖示已變更為 Link 圖示 */}
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-3 px-5 py-3 bg-slate-800 text-white font-semibold rounded-lg shadow-md transform transition-all duration-300 hover:bg-slate-900 hover:scale-105 hover:shadow-lg dark:bg-slate-700 dark:hover:bg-slate-600"
                >
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-3 px-5 py-3 bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white font-semibold rounded-lg shadow-md transform transition-all duration-300 hover:scale-105 hover:shadow-lg"
                >
                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fillRule="evenodd" d="M12.315 2c-4.04.02-5.462.164-6.527.584a5.87 5.87 0 00-2.14 1.096 5.87 5.87 0 00-1.096 2.14C2.164 6.853 2.02 8.274 2 12.315c-.02 4.04.124 5.462.544 6.527a5.87 5.87 0 001.096 2.14 5.87 5.87 0 002.14 1.096c1.065.42 2.487.564 6.527.584 4.04-.02 5.462-.164 6.527-.584a5.87 5.87 0 002.14-1.096 5.87 5.87 0 001.096-2.14c.42-1.065.564-2.487.584-6.527.02-4.04-.124-5.462-.544-6.527a5.87 5.87 0 00-1.096-2.14 5.87 5.87 0 00-2.14-1.096C17.777 2.164 16.355 2.02 12.315 2zM12 7.23a4.77 4.77 0 100 9.54 4.77 4.77 0 000-9.54zm0 7.82a3.05 3.05 0 110-6.1 3.05 3.05 0 010 6.1zM16.95 6.3a1.18 1.18 0 100 2.36 1.18 1.18 0 000-2.36z" clipRule="evenodd" />
                    </svg>
                    <span>Instagram</span>
                </a>
                {/* --- 新增的文字 --- */}
